...
::: {.callout-note}
The RCK website is not fully complete. Expect some changes between now and December 2026, the current target launch date
:::

# The DOFPro High-Power Rocketry Website

Hobby rocketry (flying rockets for recreation rather than commercial purposes) is traditionally divided into two categories: *Model Rocketry* and *High-Power Rocketry*[^1].

In the United States, model rocketry generally refers to rockets with a mass of less than **1500 grams** and either:

- a single motor with less than **160 Ns** of impulse, or  
- a cluster of motors with less than **320 Ns** of impulse.

The most popular brand of model rocket kits since the early days of the hobby has been [Estes](https://en.wikipedia.org/wiki/Estes_Industries).
...
High-Power Rocketry involves rockets with a mass greater than **1500 grams** and/or:

- a single motor with more than **160 Ns** of impulse, or  
- a cluster of motors with more than **320 Ns** of impulse.

High-power rocketry is more formally defined in the National Fire Protection Association document [NFPA 1127](https://www.nfpa.org/codes-and-standards/1/nfpa-1/2/nfpa-1127) and by the Tripoli Rocketry Association ([TRA](https://www.tripoli.org/)) and the National Association of Rocketry ([NAR](https://www.nar.org/)).

This website presents information, practices, and guidelines for high-power rocketry drawn from more than **twenty years of teaching Experimental Engineering** to college sophomores through seniors. During that time students designed, built, modeled, flew, and analyzed data from high-power rockets.
