...
* TRA is focused on High-Power rocketry and rocketry research.
  NAR is focused on model rocketry, but they support High-Power as well.

* Certifying Level 1 with TRA requires that you have a prefect, technical advisory panel, or TRI director observe the flight. Certifying
  Level 1 with NAR requires that you are observed by any member with Level 2 certification or two members, one of which having a Level 1 certification.
...
you can certify on a more complex, and more expensive rocket.
...
On the complete list of [approved motors](https://www.nar.org/content.aspx?page_id=22&club_id=114127&module_id=669684), the naming of the motors is framed as (Impuse Class) (Average Thrust) - (Time Delay)(Color)
The most popular choices for Level 1 and Level 2 certification are the [Aerotech][AT] single use motor, an [Aerotech][AT] reload, or a [CTI][CTI] reload.
Both the Aerotech and CTI reloads require you to have
...
### Madcow 1.6" Mini DX3
Coming in at about $70, this rocket will easily let you
...
is the Aerotech H128W. Recommended assembly instructions are found [here](/const/DX3.qmd).
...
don't plan on doing much more than qualifying on them. Available from [Estes][EPS], 
...
hints [below](https://dofpro.org/RCK/const/#aerotech-arreaux-motors).
Beyond the kit and
...
1. Earn your Level 1 certification.
2. By yourself, build a rocket designed to fly on J impulse, K impulse, or L impulse motors.
3. Take and pass the Level 2 qualifying test. The TRA study guide is [here][T2SG] and the NAR study
   guide is [here][N2SG]. The NAR exam consists of 37 questions taken from the list of questions. You must get 32
...
3. Prep the rocket for flight and prep the J, K, or L motor for flight by yourself.
4. Fly the rocket while the required observer is watching (at a sponsored event).
5. Bring back the safely recovered rocket to the observer to verify that no damage
   has occurred that would keep it from flying again.
...
[NMEM]: https://www.nar.org/content.aspx?page_id=22&club_id=114127&module_id=667409
[NFRM]: https://narocket.clubexpress.com/content.aspx?page_id=60&club_id=114127
[NCRT]: https://www.nar.org/content.aspx?page_id=22&club_id=114127&module_id=668315
[NL1]: https://www.nar.org/Level1HPRCertificationProcedures
