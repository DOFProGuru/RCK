...
* Certifying Level 1 with TRA requires that you have a prefect, technical advisory panal, or TRI director observe the flight. Certifying
...
On the complete list of [approved motors](https://www.nar.org/standards-and-testing-committee/nar-certified-motor-list/), the naming of the motors is framed as (Impuse Class) (Average Thrust) - (Time Delay)(Color)
...
is the Aerotech H128W. Recommended assembly instructions are found [here](https://dofpro.org/RCK/const/).
...
hints [below](https://dofpro.org/RCK/const/).
Beyond the kit and
...
[NFRM]: https://nar.app.neoncrm.com/np/clients/nar/membershipJoin.jsp
